...
class _PremiumSectionState extends State<PremiumSection> {
  ...
  Future<void> _activate() async {
    ...
    try {
      ...
      if (data.isEmpty) {
        // ↓ showAppSnack вместо голого SnackBar
        showAppSnack(context, 'Код недействителен или уже использован', isError: true);
        hapticMedium();
      ...
      if (mounted) {
        ...
        hapticHeavy(); // сильный haptic при активации Premium
        showAppSnack(context, '🔥 Premium активирован!');
        setState(() => _loading = false);
      }
    } catch (_) {
      if (mounted) {
        showAppSnack(context, 'Ошибка соединения. Проверь интернет.', isError: true);
        setState(() => _loading = false);
      }
    }
  }
      ...
      return Container(
        ...
        child: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Premium активен', style: TextStyle(fontSize: 16,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('Modo Premium', style: TextStyle(fontSize: 17,
