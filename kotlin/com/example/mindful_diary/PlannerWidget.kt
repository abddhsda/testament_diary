...
class PlannerWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun updateWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            // Flutter сохраняет Dart int как Long в SharedPreferences (через FlutterSharedPreferences).
            // Поэтому сначала пробуем getLong; если не найден (< 0) — фолбэк на getInt для совместимости.
            val accentIndex = try {
